...
REPOSITORY = "HA-Member-Adjacency"
ARCHITECTURE_TEXT = "Architecture independent"
ARCHITECTURE_BADGE = "independent"
ARCHITECTURE_LINK = "https://github.com/1bobby-git/HA-Member-Adjacency/blob/main/custom_components/member_adjacency/manifest.json"
